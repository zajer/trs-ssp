...
let test_multiply_1 _ =
    ...
    let init_situation_matrix = DSSP.init_situation_matrix init_situation_in_state ~state_idx:0 ~num_of_states:3 
    and trans_matrix_elts = Array.make 3 (Array.make 3 DSSP.No_transitions) in
